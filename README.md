...
You will also need to [set up SSH keys on your computer](https://github.com/newtfire/textEncoding-Hub/blob/main/ssh-key-and-gitconfig-setup.md) to connect to GitHub securely from your local computer. In this course, you will be learning command line git and GitHub, and this introDH-Hub can help you learn and practice. 
...
If you are a DIGIT major, in other classes (DIGIT 110, 210, 400), you'll continue to work extensively with git and GitHub on coding projects.
